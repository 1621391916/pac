/*
 * Copyright (C) 2019 SSRSHARE.COM
 * Website: https://www.ssrshare.com
 * Last Updated: 2019-08-02 00:00:02
 */
var direct = "DIRECT;";
if (direct == "__DIR" + "ECT__") direct = "DIRECT;";

var wall_proxy = function(){ return "PROXY 192.168.0.1:3080;DIRECT;"; };
var wall_v6_proxy = function(){ return "PROXY 192.168.0.1:3080;DIRECT;"; };
...
* Copyright (C) 2006-2019 Eyeo GmbH
*
